...
#include #include #include <juce\_core/juce\_core.h>

// Forward declarations — avoid pulling in full clouds headers here namespace clouds { class GranularProcessor; struct ShortFrame; }

class CloudsEngine { public: CloudsEngine(); ~CloudsEngine();
...
private: static constexpr size\_t kLargeBufferSize = 118784; static constexpr size\_t kSmallBufferSize = 65535;
