...
class CloudsVSTEditor : public juce::AudioProcessorEditor { public: explicit CloudsVSTEditor(CloudsVSTProcessor&); ~CloudsVSTEditor() override;
...
private: CloudsVSTProcessor& processorRef\_;
