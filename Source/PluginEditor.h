...
private:
    ...
    juce::Slider inputTrimKnob_, outputGainKnob_, limiterKnob_;
    ...
    juce::Label inputTrimLabel_, outputGainLabel_, limiterLabel_, inputGainLabel_, modeLabel_, qualityLabel_;
