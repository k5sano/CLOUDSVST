...
AudioProcessorEditor(&p), processorRef\_(p) { setSize(620, 420);
...
void CloudsVSTEditor::setupKnob(juce::Slider& slider, juce::Label& label, const juce::String& text) { slider.setSliderStyle(juce::Slider::RotaryHorizontalVerticalDrag); slider.setTextBoxStyle(juce::Slider::TextBoxBelow, false, 56, 16); addAndMakeVisible(slider);
...
void CloudsVSTEditor::paint(juce::Graphics& g) { g.fillAll(juce::Colour(0xff1a1a2e));
...
void CloudsVSTEditor::resized() { auto area = getLocalBounds().reduced(10); area.removeFromTop(30); // Title area.removeFromBottom(20); // Credit
