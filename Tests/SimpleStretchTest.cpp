...
int main()
{
    std::cout << "=== Simple Stretch Test ===" << std::endl;
    ...
    // Stretch mode directly
    std::cout << "Setting PLAYBACK_MODE_STRETCH..." << std::endl;
    ...
    std::cout << "Calling Prepare() 100 times..." << std::endl;
    for (int i = 0; i < 100; ++i)
        processor.Prepare();
    ...
    // First process with detailed logging
    std::cout << "Processing first block..." << std::endl;
    ...
    processor.Prepare();
    std::cout << "Prepare done. About to call Process()..." << std::endl;
    ...
    // Continue for 10 more blocks
    std::cout << "Processing 10 more blocks..." << std::endl;
    for (int block = 0; block < 10; ++block)
    {
        ...
        std::cout << "  Block " << block << " maxOut: " << maxOut << std::endl;
    }

    std::cout << "Final maxOutput: " << maxOut << std::endl;
