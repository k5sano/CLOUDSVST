#include <juce\_audio\_processors/juce\_audio\_processors.h> #include "PluginProcessor.h" #include "Parameters.h"

//============================================================================== // Basic parameter validation tests //============================================================================== class ParameterTests : public juce::UnitTest { public: ParameterTests() : juce::UnitTest("Parameter Tests") {}
...
void runTest() override
{
    ...
    {
        auto layout = CloudsVST::createParameterLayout();
        // We defined 14 parameters in Parameters.h
        expect(layout.size() == 14,
               "Expected 14 parameters, got " + juce::String(layout.size()));
    }
...
//============================================================================== // Entry point for juce console test runner //============================================================================== int main(int /_argc_/, char\* /_argv_/\[\]) { juce::UnitTestRunner runner; runner.runAllTests();
